...
static inline int
ordo_lt_clock(unsigned long t1, unsigned long t2) {
    return (t1 < t2) && ((t2 - t1) > g_ordo_boundary);
}

static inline int
ordo_gt_clock(unsigned long t1, unsigned long t2) {
    return (t1 > t2) && ((t1 - t2) > g_ordo_boundary);
}

static inline int
ordo_cmp_clock(unsigned long t1, unsigned long t2) {
...
static inline unsigned long
ordo_new_clock(unsigned long t) {
