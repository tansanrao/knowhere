...
void*
dram_alloc(size_t size);
void*
dram_calloc(size_t num, size_t size);
void*
dram_realloc(void** ptr, size_t size);
void
dram_free(void* addr);
void
flush_to_nvm(void* addr, size_t size);
